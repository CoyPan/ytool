...
var ytool = {
     ...
     * If [immediate] is passed, trigger the func immediately when it is called at firsttime;
     * 
     * @param {Function} func the function need to be triggered
     * @param {string} wait the spacing interval
     * @param {boolean|undefined} immediate
     * 
     * @return {Function} the decorated func
     */
